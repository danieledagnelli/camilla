...
@NbBundle.Messages({
    "CTL_ImageGalleryAction=Camilla Graph Builder",
    "CTL_ImageGalleryTopComponent=Camilla Graph Builder"
})
@SuppressWarnings("PMD.SingularField") // UI widgets cause lots of false positives
public class CamillaTopComponent extends TopComponent implements DataResultViewer, ExplorerManager.Provider, Lookup.Provider {
     ...
     */
    @NbBundle.Messages("CamillaTopComponent.title=Camilla Graph Builder")
    public CamillaTopComponent() {
        this(null, Bundle.CamillaTopComponent_title());
     ...
     * component.
     */
    public CamillaTopComponent(ExplorerManager explorerManager) {
        this(explorerManager, Bundle.CamillaTopComponent_title());
    }
     ...
     */
    public CamillaTopComponent(ExplorerManager explorerManager, String title) {
...
//        }
    ...
    public String getTitle() {
        return Bundle.CamillaTopComponent_title();
    }
    ...
    private void populateColumnMap() {
        ...
        for (Map.Entry<Integer, Node.Property<?>> entry : propertiesMap.entrySet()) {
     ...
     */
    synchronized private void assignColumns(List<Node.Property<?>> props) {
        String[] propStrings = new String[props.size() * 2];
        for (int i = 0; i < props.size(); i++) {
            final Node.Property<?> prop = props.get(i);
    ...
    private synchronized List<Node.Property<?>> loadColumnOrder() {
        ...
        List<Node.Property<?>> props = ResultViewerPersistence.getAllChildProperties(rootNode, 100);
    ...
    private class PagingSupport {
        ...
        void gotoPage() {
            ...
            if (currentPage > totalPages || currentPage < 1) {
                ...
                JOptionPane.showMessageDialog(CamillaTopComponent.this,
        ...
        void postPageChangeEvent() {
            ...
            CamillaTopComponent.this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            updateControls();
        }
    ...
    private class TableListener extends MouseAdapter implements TableColumnModelListener {
        ...
        public void columnMoved(TableColumnModelEvent e) {
            ...
            if (fromIndex < toIndex) {
                ...
                Node.Property<?> movedProp = propertiesMap.get(range.get(0));
                ...
                Node.Property<?> movedProp = propertiesMap.get(range.get(rangeSize - 1));
        ...
        private void columnAddedOrRemoved() {
            if (listenToVisibilitEvents) {
                SwingUtilities.invokeLater(CamillaTopComponent.this::storeColumnVisibility);
    ...
    private void initComponents() {
        ...
        outlineView = new CamillaOutlineView(CamillaTopComponent.FIRST_COLUMN_LABEL);
        canvasPanel = new CamillaCanvas();

        pageLabel.setText(org.openide.util.NbBundle.getMessage(CamillaTopComponent.class, "DataResultViewerTable.pageLabel.text")); // NOI18N

        pageNumLabel.setText(org.openide.util.NbBundle.getMessage(CamillaTopComponent.class, "DataResultViewerTable.pageNumLabel.text")); // NOI18N

        pagesLabel.setText(org.openide.util.NbBundle.getMessage(CamillaTopComponent.class, "DataResultViewerTable.pagesLabel.text")); // NOI18N
        ...
        pagePrevButton.setText(org.openide.util.NbBundle.getMessage(CamillaTopComponent.class, "DataResultViewerTable.pagePrevButton.text")); // NOI18N
        ...
        pageNextButton.setText(org.openide.util.NbBundle.getMessage(CamillaTopComponent.class, "DataResultViewerTable.pageNextButton.text")); // NOI18N
        ...
        gotoPageLabel.setText(org.openide.util.NbBundle.getMessage(CamillaTopComponent.class, "DataResultViewerTable.gotoPageLabel.text")); // NOI18N

        gotoPageTextField.setText(org.openide.util.NbBundle.getMessage(CamillaTopComponent.class, "DataResultViewerTable.gotoPageTextField.text")); // NOI18N
        ...
        exportCSVButton.setText(org.openide.util.NbBundle.getMessage(CamillaTopComponent.class, "CamillaViewerTable.exportCSVButton.text")); // NOI18N
    ...
    private void pagePrevButtonActionPerformed(java.awt.event.ActionEvent evt) {
        pagingSupport.previousPage();
    }

    private void pageNextButtonActionPerformed(java.awt.event.ActionEvent evt) {
        pagingSupport.nextPage();
    }

    private void gotoPageTextFieldActionPerformed(java.awt.event.ActionEvent evt) {
