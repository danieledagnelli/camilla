...
public class CamillaResultPanel extends javax.swing.JPanel implements DataResult, ChangeListener, ExplorerManager.Provider {

    private static final long serialVersionUID = 1L;
    private static final int NO_TAB_SELECTED = -1;
    private static final String PLEASE_WAIT_NODE_DISPLAY_NAME = NbBundle.getMessage(CamillaResultPanel.class, "DataResultPanel.pleasewaitNodeDisplayName");
     ...
     */
    public static CamillaResultPanel createInstance(String title, String description, Node currentRootNode, int childNodeCount) {
        CamillaResultPanel resultPanel = new CamillaResultPanel(title, false, Collections.emptyList(), DataContentTopComponent.findInstance());
     ...
     * @return A result view panel.
     */
    public static CamillaResultPanel createInstance(String title, String description, Node currentRootNode, int childNodeCount, Collection<DataResultViewer> viewers) {
        CamillaResultPanel resultPanel = new CamillaResultPanel(title, false, viewers, DataContentTopComponent.findInstance());
        createInstanceCommon(title, description, currentRootNode, childNodeCount, resultPanel);
        resultPanel.open();
        return resultPanel;
    }
     ...
     * @return A result view panel.
     */
    public static CamillaResultPanel createInstance(String title, String description, Node currentRootNode, int childNodeCount, DataContent customContentView) {
        CamillaResultPanel resultPanel = new CamillaResultPanel(title, false, Collections.emptyList(), customContentView);
        createInstanceCommon(title, description, currentRootNode, childNodeCount, resultPanel);
        resultPanel.open();
        return resultPanel;
    }
     ...
     * @return A result view panel.
     */
    public static CamillaResultPanel createInstanceUninitialized(String title, String description, Node currentRootNode, int childNodeCount, DataContent customContentView) {
        CamillaResultPanel resultPanel = new CamillaResultPanel(title, false, Collections.emptyList(), customContentView);
        createInstanceCommon(title, description, currentRootNode, childNodeCount, resultPanel);
        return resultPanel;
    }
     ...
     */
    private static void createInstanceCommon(String title, String description, Node currentRootNode, int childNodeCount, CamillaResultPanel resultViewPanel) {
     ...
     */
    CamillaResultPanel(String title, boolean isMain, Collection<DataResultViewer> viewers, DataContent contentView) {
        this.setTitle(title);
        this.isMain = isMain;
    ...
    public void stateChanged(ChangeEvent event) {
        ...
        if (currentTab != CamillaResultPanel.NO_TAB_SELECTED) {
